...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    const users = [
...

      {
        ...
        address:
          '323 Montague Terrace, Fillmore, Northern Mariana Islands, 4551',
        about:
          'Pariatur in id ad nostrud ad incididunt non est. Nisi culpa ullamco eiusmod eiusmod minim eu. Consectetur dolor nostrud qui aliqua.\r\n',
      ...
      },
      {
        ...
        about:
          'Aliqua aliquip quis nostrud aute nostrud ut quis aute mollit. Eu et esse voluptate nulla cupidatat eu ut laborum consequat tempor ad do. Velit occaecat cupidatat laboris ea deserunt.\r\n',
      ...
      },
      {
        ...
        about:
          'Elit adipisicing eu do ipsum deserunt ea. Sit magna id fugiat exercitation consectetur proident qui est eiusmod consequat dolore. Amet sint ut culpa elit consectetur ex velit ut irure ea proident nisi dolore.\r\n',
  ...
  genId(users: User[]): any {
    return users.length > 0
      ? Math.max(...users.map((user) => +user._id)) + 1
      : 6;
  }
}
